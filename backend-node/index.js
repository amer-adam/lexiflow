...
// MongoDB connection
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://ameradam6a_db_user:FQ5y6hnE1vKPpmEi@lexiflow.2uerdjh.mongodb.net/?appName=lexiflow';
const DB_NAME = process.env.DB_NAME || 'lexiflow';
const JOBS_COLLECTION = process.env.JOBS_COLLECTION || 'jobs';
const RESULTS_COLLECTION = process.env.RESULTS_COLLECTION || 'results';
const AGENDA_COLLECTION = process.env.AGENDA_COLLECTION || 'agendaJobs';
const USER_VIDEOS_COLLECTION = 'user_videos';
const PYTHON_API = process.env.PYTHON_API || 'http://localhost:4557';
